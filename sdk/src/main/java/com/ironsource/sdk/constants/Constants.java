...
public class Constants {
    ...
    public static final String SDK_VERSION = "5.53";
    ...
    public static class JSMethods {
        ...
        public static JSMethods getInitMethodByProduct(SSAEnums.ProductType type) {
            JSMethods initMethod = new JSMethods();

            if (type == SSAEnums.ProductType.RewardedVideo) {
                initMethod.methodName = "initRewardedVideo";
                initMethod.successCallbackName = "onInitRewardedVideoSuccess";
                initMethod.failureCallbackName = "onInitRewardedVideoFail";
            } else if (type == SSAEnums.ProductType.Interstitial) {
                initMethod.methodName = "initInterstitial";
                initMethod.successCallbackName = "onInitInterstitialSuccess";
                initMethod.failureCallbackName = "onInitInterstitialFail";
            } else if (type == SSAEnums.ProductType.OfferWall) {
                initMethod.methodName = "initOfferWall";
                initMethod.successCallbackName = "onInitOfferWallSuccess";
                initMethod.failureCallbackName = "onInitOfferWallFail";
            }
        ...
        public static JSMethods getShowMethodByProduct(SSAEnums.ProductType type) {
            JSMethods showMethod = new JSMethods();

            if (type == SSAEnums.ProductType.RewardedVideo) {
                showMethod.methodName = "showRewardedVideo";
                showMethod.successCallbackName = "onShowRewardedVideoSuccess";
                showMethod.failureCallbackName = "onShowRewardedVideoFail";
            } else if (type == SSAEnums.ProductType.Interstitial) {
                showMethod.methodName = "showInterstitial";
                showMethod.successCallbackName = "onShowInterstitialSuccess";
                showMethod.failureCallbackName = "onShowInterstitialFail";
            } else if (type == SSAEnums.ProductType.OfferWall) {
                showMethod.methodName = "showOfferWall";
                showMethod.successCallbackName = "onShowOfferWallSuccess";
                showMethod.failureCallbackName = "onInitOfferWallFail";
            }
...
/* Location:              /Users/lml/Downloads/mediationsdk-6.7.10.jar!/com/ironsource/sdk/constants/Constants.class
